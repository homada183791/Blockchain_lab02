...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0x934F481daF0fc83ecE7275b10DC574067d7e7e5f",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9959144,
    },
    MyUSD: {
      address: "0xA9883890f408989b4A50932F2c1E1e8581b08A3f",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959143,
    },
    MyUSDEngine: {
      address: "0xaFea59e503307b39b1eFF91332352a0b3fe59E9A",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959149,
    },
    MyUSDStaking: {
      address: "0x31c4d0652Adef9Fd661C4769B1BD3a74Eb0c63ea",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9959148,
    },
    Oracle: {
      address: "0xbC7F5Af64605870B567dE16ee3bB123E4112c58B",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9959145,
    },
    RateController: {
      address: "0x9EAF8F7fB07c1119cA4A034b81a830f7577DaDa3",
      abi: [
        {
          inputs: [
            {
